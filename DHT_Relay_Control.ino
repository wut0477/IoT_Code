/*
 Cretdit Website  https://randomnerdtutorials.com/
...
float temp_set = 28.5;	 //  กำหนดค่าให้กับตัวแปร temp_set = 28.5 
String tp = "";

AsyncWebServer server(80);  

//"unsigned long" สำหรับตัวแปรที่มีเวลา ค่าจะใหญ่เกินไปอย่างรวดเร็วสำหรับ int ที่จะจัดเก็บ
...
void loop(){  
  ...
  if (currentMillis - previousMillis >= interval) {  
    ...
    //float newT = dht.readTemperature(true);  // อ่านอุณหภูมิเป็นฟาเรนไฮต์ (isFahrenheit = true)
